...
<div class="wrapper">
	...
	<nav class="navbar navbar-expand-lg af-navbar">
		<div class="container-fluid">
			...
			<!-- Brand / Logo -->
			<a class="navbar-brand" href="<?php echo base_url();?>projects">
			...
			<div class="collapse navbar-collapse" id="afMainNav">
				...
				<ul class="navbar-nav me-auto mb-2 mb-lg-0">
					<?php
					$menu_list = user_menu_list_helper($sessionDetailsArr['userType'], $sessionDetailsArr['menu_ids']);
					foreach ($menu_list as $category_data) {
						...
						$submenu_list = user_submenu_list_helper($category_data->id, $sessionDetailsArr['userType'], $sessionDetailsArr['submenu_ids']);
								...
								<ul class="dropdown-menu">
									<?php foreach ($submenu_list as $subcategory_data) {
										if (isset($subcategory_data->submenu_active_class) && $subcategory_data->submenu_active_class != '') {
											$submenu_subcat_list = user_submenu_subcat_list_helper($subcategory_data->id, $sessionDetailsArr['userType'], $sessionDetailsArr['submenu_subcat_ids']);
												...
												<li class="dropdown-submenu">
													...
													<ul class="dropdown-menu">
														<?php foreach ($submenu_subcat_list as $submenu_subcat_data) { ?>
															<li>
																<a class="dropdown-item" href="<?php echo base_url() . $submenu_subcat_data->subcate_link; ?>">
											...
											<li>
												<a class="dropdown-item" href="<?php echo base_url() . $subcategory_data->redirect_link; ?>">
													<?php echo $subcategory_data->submenu_name; ?>
												</a>
											</li>
									<?php }
						...
						<?php } else { ?>
							<li class="nav-item <?php if($isActive) echo 'af-active'; ?>">
								<a class="nav-link" href="<?php echo base_url() . $category_data->menu_link; ?>">
									<i class="<?php echo $category_data->icon; ?> af-nav-icon"></i>
									<?php echo $category_data->menu_name; ?>
								</a>
							</li>
				...
				<ul class="navbar-nav">
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle af-profile-toggle" href="#" role="button"
						   data-bs-toggle="dropdown" aria-expanded="false">
							...
							<span class="af-user-name d-none d-lg-inline">
								<?php echo ucwords(strtolower($sessionDetailsArr['auName'])); ?>
							</span>
						</a>
						<ul class="dropdown-menu dropdown-menu-end af-profile-dropdown">
							...
							<li>
								<div class="af-profile-header">
									...
									<?php }else{ ?>
										<img src="<?php echo base_url();?>assets/backend/images/default-avatar.jpg" alt="User" />
									<?php } ?>
									<div class="af-pname"><?php echo ucwords(strtolower($sessionDetailsArr['auName'])); ?></div>
									<div class="af-prole">
										<?php
										echo $this->config->item('user_types_array_config')[$sessionDetailsArr['userType']]['name'];
										if(isset($sessionDetailsArr['addedBy']) && $sessionDetailsArr['addedBy']>0){
											echo ' (Guest)';
										}
										?>
									</div>
							...
							<li>
								<a class="dropdown-item" href="<?php echo base_url();?>access">
									<i class="fa fa-key"></i> Guest Access
								</a>
							</li>
							<?php } ?>
							<li>
								<a class="dropdown-item" href="<?php echo base_url();?>tickets">
									<i class="fa fa-envelope"></i> Contact Support
								</a>
							</li>
							<li>
								<a class="dropdown-item" href="<?php echo base_url();?>home/ameelab">
