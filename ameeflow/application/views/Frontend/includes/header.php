		...
		<div class="navbar-custom-menu nbs-five"> 
			<ul class="nav navbar-nav">
				...
				<a href="#" class="dropdown-toggle" class="dropdown-toggle" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
					...
					<?php } ?>
					<span class="hidden-xs1 fmc fs16"><?php echo 'Hi, '.ucwords(strtolower($sessionDetailsArr['auName'])); ?> </span>
				</a>
					<ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
						<li class="user-header">
							...
							<?php } ?>
							<div style="color: rgb(255, 255, 255); font-size: 14px; font-weight: 500; text-align: center; margin-top: 10px;">
								Last Login <br>  
						...
						<li class="user-footer">
							<div class="pull-left">
								<a href="<?php echo base_url();?>profile" class="btn btn-default btn-flat"><i class="fa fa-user"></i> Profile</a>
							</div>
							<?php if($sessionDetailsArr['lightAccess']==0){ ?>
							<div class="pull-right">
								<a href="<?php echo base_url();?>signin/logout" class="btn btn-default btn-flat"><i class="fa fa-sign-out"></i> Sign out</a>
							</div>
							<?php } ?>
						</li>
					</ul>
		...
		<section class="sidebar" style="height: auto;">
			<div class="user-panel">
				...
				<div class="pull-left info">
					<p><?php echo ucwords(strtolower($sessionDetailsArr['auName']));?> </p> 
			...
			<ul class="sidebar-menu">
				<li class="header header-3">MAIN NAVIGATION</li>
				<?php include(APPPATH.'views/Frontend/includes/menu.php'); ?>
			</ul>
		</section>
	</aside>
