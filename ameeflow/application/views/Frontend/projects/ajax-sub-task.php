...
<div class="">
    ...
    <div class="poptaskArea">
        ...
        <h6 > <label class="dueDateBrdr"><?php echo 'Due Date: '.date('m/d/Y',$taskDetailsArr['dueDateStr']);?> </label> </h6>
...
<div class="">
    ...
    <?php foreach($otherDoc as $od){
        ...
        <a <?php if($od['docType']==1 || $od['docFileExt']=='pdf'){ ?> target="_blank"<?php } ?> id="proTitle<?php echo $od['docId'];?>" class="cp" href="<?php echo $rLnk;?>">
        <table class="table odTbl">
            <tr>
                <td width="20%" align="center">
                    <?php if($od['docType']==1){ 
                            echo '<i class="faInfo fa fa-link"></i>';
                        }else{
                            if($od['docFileExt']=='pdf'){ 
                                echo '<i class="faInfo fa fa-file-pdf-o"></i>';
                            }else if($od['docFileExt']=='docx' || $od['docFileExt']=='docx'){ 
                                echo '<i class="faInfo fa fa-file-word-o"></i>';
                            }else if($od['docFileExt']=='xls' || $od['docFileExt']=='xlsx' || $od['docFileExt']=='csv'){ 
                                echo '<i class="faInfo fa fa-file-excel-o"></i>';
                            }else if($od['docFileExt']=='ppt' || $od['docFileExt']=='pptx'){ 
                                echo '<i class="faInfo fa fa-file-powerpoint-o"></i>';
                            }else{
                                echo '<i class="faInfo fa fa-file-text-o"></i>';
                            }
                        } 
                    ?>
                </td>
                <td> <?php echo $od['docTitle'];?> <i class="fa fa-external-link" aria-hidden="true"></i> </td>
            </tr>
        </table>
        </a>
