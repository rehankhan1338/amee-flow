    ...
    <div class="af-report-page">
        ...
        <div class="af-report-topbar">
            <div class="af-report-topbar-left">
                <a href="<?php echo base_url().'general_reports';?>" class="af-report-back-btn">
                    <i data-feather="arrow-left"></i> Back
                </a>
                <h4 class="af-report-topbar-title">General Report</h4>
            </div>
            <div class="af-report-topbar-right">
                <button type="button" id="generateReport" class="af-report-action-btn af-report-action-edit" onclick="return genAIGeneralReport('<?php echo $reportDetails['rId'];?>');">
