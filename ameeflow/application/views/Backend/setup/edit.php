              ...
              <div class="box-body">
                <div class="col-md-10">
						...
						<div class="col-sm-9">
							...
							<select class="form-control required" id="parentId" name="parentId"> 
								...
								<?php  foreach ($zones_arr as $zone) {?>
									<option value="<?php echo $zone['id'];?>" <?php if($setup_masters_details->parentId==$zone['id']){?> selected="selected"<?php } ?>><?php echo $zones_prefix.$zone['name'];?></option>
								<?php } ?>
							</select>
						</div>
					 </div> 
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="form-control <?php if($section_status==2 || $section_status==1){echo 'number';}?> required" id="txt_name" name="txt_name" placeholder="<?php echo $section_status_label;?> <?php if($section_status==2 || $section_status==1){echo '#';}else{echo 'Name';}?>" value="<?php echo $setup_masters_details->name;?>"  >
						</div>
					 </div> 
