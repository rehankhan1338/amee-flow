        ...
        <div class="box-body row">					 
            ...
            <table class="table table-striped" id="table_recordtbl1">
                    ...
                    <tbody id="append_company_products">
                        <?php $i = 1;
                            foreach($generalReportDataArr as $row){                        
                        ?>
                        <tr>
                            <td> <?php echo $i;?> </td>
<td class="fw600"> <a class="cp" onclick="return viewCompleteReport('<?php echo $row['rId'];?>','<?php echo $row['erId'];?>','<?php echo $row['userId'];?>','<?php echo $shareReportFor;?>');"> <?php echo $row['topicName']; ?> &nbsp;<i id="vrpt<?php echo $row['rId'];?>" class="fa fa-info-circle"></i> </a>  </td>
