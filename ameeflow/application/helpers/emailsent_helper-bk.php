<?php if ( ! defined('BASEPATH')) exit('No direct script access allowed');
 if( !function_exists('send_mail') ) {
	...
	function send_mail($to,$message,$title,$status,$subject, $cc=0) {
		...
		$mail->AddReplyTo($configuration_details->smtp_username,$from_title);  //email address that receives the response
		...
		if($cc==1){
			//$mail->AddCC('sakilekai@yahoo.com', 'Sakile');
		}
		$mail->AddCC('tns.ankit@gmail.com', 'Ankit');
