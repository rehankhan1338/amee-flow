...
<div class="form-group">
	<div class="col-md-12 ">
		...
		<select class="form-control" onchange="return manage_automatic_multiple_choice(this.value);" style="margin-top:10px;">
...
<script type="text/javascript">
	function manage_automatic_multiple_choice(auto_scale_id){
		...
		$.ajax({url: "<?php echo base_url();?>admin/survey_template/get_multiple_choice_rating_ajax?scale_id="+auto_scale_id, 
			beforeSend: function(){ 
				$('.multiple_choices_manage').html('<img src="<?php echo base_url();?>assets/backend/images/ajax-loading.gif" class="centered" />');
			},
...
<script type="text/javascript">
	function manage_automatic_scale_point(auto_scale_id){
		$.ajax({url: "<?php echo base_url();?>admin/survey_template/get_matrix_scale_point_rating_ajax?scale_id="+auto_scale_id, 
			beforeSend: function(){ 
				$('.loader_result_apply_automatic_matrix_scales').html('<img src="<?php echo base_url();?>assets/backend/images/ajax-loading.gif" class="centered" />');
			},
			success: function(result){
				if(result!=''){
