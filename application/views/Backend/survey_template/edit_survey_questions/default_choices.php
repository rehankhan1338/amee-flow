...
<?php if(count($get_choics)>0){

$r=1;foreach($get_choics as $choics){?>
...
<div class="form-group" id="old_div_choice_<?php echo $r;?>" style="padding-left:50px;">
	<input type="text" name="old_choice_<?php echo $choics->answer_id ;?>" id="old_choice_<?php echo $choics->answer_id ;?>" class="form-control required" value="<?php echo $choics->answer_choice ;?>"  placeholder="Insert text to write Choice <?php echo $r;?>" style="width:40%; display:inline-block; "  />&nbsp;&nbsp;<a href="<?php echo base_url();?>admin/survey_template/delete_question_choice?answer_id=<?php echo $choics->answer_id ;?>&question_id=<?php echo $edit_question_fulldetails->question_id;?>&question_type=<?php echo $edit_question_fulldetails->question_type;?>" onclick="return confirm('Are you sure you want to delete this choice?');" class="btn btn-danger btn-xs"  >Delete</a>
</div>
