...
<!--<div class="form-group is_demo_question" style="padding-left:50px; padding-top:10px;">
	...
	<input type="radio" name="is_demography" id="is_demography" value="1" class="required" style="margin: 0 0 0 10px;"/> &nbsp;Yes &nbsp;&nbsp;
	<input type="radio" name="is_demography" id="is_demography" value="0" class="required" style="margin: 0 0 0 10px;"/> &nbsp;No
</div>-->
<?php } ?>
