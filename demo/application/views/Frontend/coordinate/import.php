...
$count_rows=count($sheetData);
    ...
    $count=count($data1);
		...
		?>
        <div class="contenttitle2 nomargintop"><h3>Step 2 of 2 - Match and Import <?php echo ucfirst($course_status);?> Courses</h3></div> 
        <div class="col-md-12">
<form name="submit" id="submit" action="<?php echo base_url();?>department/coordinate/action2/import_data_courses/<?php echo $course_status;?>" method="post">
    ...
    <?php	
		...
		mysqli_query($default_con,'TRUNCATE TABLE '.$db_subdomain_name.'import_error_log');
			...
			$sql_query = "INSERT INTO ".$db_subdomain_name."temp_import_table(department_id,col_1,col_2,col_3) VALUES ('$department_id','$col_1','$col_2','$col_3')";
