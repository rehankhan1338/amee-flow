				...
				<div class="panel panel-default">
					<div class="panel-heading">
						<h4 class="panel-title">
							<a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion<?php echo $loop;?>" href="#collapse<?php echo $loop;?>" aria-expanded="false"><?php if($lable_status==1){echo 'Program Curriculum';}else if($lable_status==2){echo 'Academic Processes';}else{echo 'Evaluation Plan';}?> <b>(+)</b></a>
						</h4>
					</div>
