		...
		<thead>
			<tr class="append_matric_column trbg" style="text-align:center;">
				...
				<td class="matrix_column td_matrix_column_1">
					...
					<input type="text" name="oprf_column_1" id="oprf_column_1" value="" class="form-control nxt_input required" placeholder="H" />
					<b>&ndash;</b>
					<input type="text" name="oprf_column_sec_1" id="oprf_column_sec_1" value="" class="form-control nxt_input required" placeholder="L" />
				</td>	
				...
				<td class="matrix_column td_matrix_column_2">
					...
					<input type="text" name="oprf_column_2" id="oprf_column_2" value="" class="form-control nxt_input required" placeholder="H" />
					<b>&ndash;</b>
					<input type="text" name="oprf_column_sec_2" id="oprf_column_sec_2" value="" class="form-control nxt_input required" placeholder="L" />
				</td>
				...
				<td class="matrix_column td_matrix_column_3">
					...
					<input type="text" name="oprf_column_3" id="oprf_column_3" value="" class="form-control nxt_input required" placeholder="H" />
					<b>&ndash;</b>
					<input type="text" name="oprf_column_sec_3" id="oprf_column_sec_3" value="" class="form-control nxt_input required" placeholder="L" />
				</td>	
				...
				<td class="matrix_column td_matrix_column_4">
					...
					<input type="text" name="oprf_column_4" id="oprf_column_4" value="" class="form-control nxt_input required" placeholder="H" />
					<b>&ndash;</b>
					<input type="text" name="oprf_column_sec_4" id="oprf_column_sec_4" value="" class="form-control nxt_input required" placeholder="L" />
				</td>
			</tr>
		</thead>
