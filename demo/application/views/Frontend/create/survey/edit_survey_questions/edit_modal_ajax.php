<?php if(isset($survey_question_fulldetails->question_type) && ($survey_question_fulldetails->question_type==1 || $survey_question_fulldetails->question_type==7 || $survey_question_fulldetails->question_type==8)){ 				
