...
<div class="survey_heading">
	<h3><?php echo ucwords($test_details->test_title);?> : : Demographic Question : : Add</h3>
</div>
<div class="clearfix"></div>
...
.error {color: #a94442;font-size: 15px !important;font-style: italic;padding-left:5px;font-weight:600;}
...
<form data-toggle="validator" class="form-horizontal" action="<?php echo base_url();?>tests/demography_question_save" id="frm" method="post" enctype="multipart/form-data">
	...
	<div class="col-md-12 survey_inner_question_title">
		...
		<div class="col-md-12 form-group">
			<input type="text" class="form-control required" id="tests_question_title" style="height:40px; width:100%;" name="tests_question_title" placeholder="Question Title" value="" />
		</div>
	</div>
	...
	<div class="col-md-2" >
	 	<div class="form-group">
			<div class="contenttitle2 nomargintop">
				<h3> Question Type</h3>
				<input type="hidden" name="hidden_test_id" id="hidden_test_id" value="<?php echo $test_details->test_id;?>" />
			...
			<?php $master_question_type = get_master_question_type_test_h();?>
	...
	function manage_questions(question_type_id){
		...
		jQuery("#hidden_question_type").val(question_type_id);
		 ...
		 if(question_type_id!=''){
			...
			jQuery.ajax({
				url: '<?php echo base_url(); ?>tests/get_default_demography_question_choice?question_type='+question_type_id,
				type: 'GET',
				beforeSend: function () {
				...
				success: function (result) {  //alert(result);
					...
					//if(question_type_id==1 || question_type_id==2 || question_type_id==3){
						jQuery.ajax({
							url: '<?php echo base_url(); ?>tests/get_demography_action_html_of_answer?question_type='+question_type_id,
							type: 'GET',
							beforeSend: function () {
