        	...
        	<div class="row">
            	<div class="col-md-12">
                	<div class="survey_name">
                    	<h1><?php $department_details = get_department_fulldetails_h($assingment_detail->department_id); echo $department_details->department_name;?></h1>
					...
					<div class="google_translate" align="right"></div>
                </div>
            </div>
