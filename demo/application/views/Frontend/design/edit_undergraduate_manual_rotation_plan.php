		...
		<?php foreach($department_pslos_undergraduate as $undergraduate_pslos){
			...
			<tr>
				<td style="vertical-align:middle">
					...
					<h4><i><?php echo ucfirst($undergraduate_pslos->plso_prefix.': '.$undergraduate_pslos->plso_title);?></i></h4>
				</td>
				...
				<td>
					...
					<select class="form-control" multiple="multiple" name="couses_id<?php echo $rpy.$undergraduate_pslos->id;?>[]" id="couses_id<?php echo $rpy.$undergraduate_pslos->id;?>[]" style="width:115px; padding:5px;">
						<option value="">-- select --</option>
					<?php foreach($department_courses_result_undergraduate as $undergraduate_courses_details){?>
						<option value="<?php echo $undergraduate_courses_details->id;?>" <?php if(in_array($undergraduate_courses_details->id,$academic_courses_details_arr)){?> selected="selected" <?php } ?> ><?php echo $undergraduate_courses_details->course_prefix.' '.$undergraduate_courses_details->course_number;?></option>
					<?php } ?>
					</select>
