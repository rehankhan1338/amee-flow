...
<a href="<?php echo base_url();?>department/design/action3?tab_id=2&status=<?php echo $graduate_status_value;?>&edit=1" class="btn btn-primary"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
</div>
<div class="clearfix"></div>
	<table class="table table-bordered mart10">
		...
		<?php foreach($department_pslos_graduate as $graduate_pslos){
			...
			?>
			<tr>
				<td style="vertical-align:middle;"><h4><i><?php echo ucfirst($graduate_pslos->plso_prefix.': '.$graduate_pslos->plso_title);?></i></h4></td>
