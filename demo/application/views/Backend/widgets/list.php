...
<div class="row">
<?php $i=0; foreach ($widgets_list as $widgets_data) { ?>
<script type="text/javascript">
$(function () {
	$('#wid_<?php echo $widgets_data->widget_key;?>').validate({
		ignore: [], 
		...
		<?php foreach ($widgetsmeta_list as $widgetsmeta_data) {?>
			...
			<div class="form-group">
				...
				<?php }else if($widgetsmeta_data->field_type==2){ ?>
					...
					<textarea class="form-control <?php if($widgetsmeta_data->is_required==0){ echo 'required';}?>" id="<?php echo $widgetsmeta_data->meta_key.$widgets_data->id;?>" name="<?php echo $widgetsmeta_data->meta_key.$widgets_data->id;?>" rows="<?php echo $widgetsmeta_data->textarea_height;?>" placeholder="<?php echo $widgetsmeta_data->placeholder;?>"><?php echo $widgetsmeta_data->meta_value;?></textarea>
