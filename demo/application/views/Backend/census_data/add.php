<form class="censusFrm" id="censusFrm" method="post" action="admin/census_data/createEntry">
	...
	<div class="col-md-12">
		<div class="box">
			...
			<div class="box-footer" style="border-top: none; margin-top: -15px;">
				<button class="btn btn-primary" id="submitBtn" type="submit">Submit Now!</button>
			</div> 
		</div>	
	</div>
</form> 
