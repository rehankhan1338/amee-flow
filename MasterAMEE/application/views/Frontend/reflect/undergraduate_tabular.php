...
<form method="post" action="<?php echo base_url();?>reflect/save_undergraduate_measurement_benchmark_tabular">
	...
	<tr class="trbg">
		...
		<th class="recourses" width="22.3%" nowrap="nowrap" colspan="<?php //echo count($undergraduate_DAM_arr);?>">Direct Measures <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo $this->config->item('reflect_sec_info_Direct_Measures');?>"></i></th>

		<th class="recourses" width="22.3%" nowrap="nowrap" colspan="<?php //echo count($undergraduate_INDAM_arr);?>">Indirect Measures <i class="fa fa-info-circle" data-toggle="tooltip" data-placement="top" title="<?php echo $this->config->item('reflect_sec_info_Indirect_Measures');?>"></i></th>
...
#undergraduate_checkboxes<?php echo $academic_year;?> {
...
#undergraduate_checkboxes<?php echo $academic_year;?> label {

  display: inline-block;padding: 3px 15px;width: 100%;color: #fff;font-size: 17px; text-align:left;

  }

#undergraduate_checkboxes<?php echo $academic_year;?> label:hover {
...
function undergraduate_showCheckboxes<?php echo $academic_year;?>() {

  var checkboxes = document.getElementById("undergraduate_checkboxes<?php echo $academic_year;?>");

  if (!expanded) {

  	jQuery('#undergraduate_direct_assesment<?php echo $academic_year;?>').html('<option>Click Here to Hide Options</option>'); 
    ...
    expanded = true;
  	...
  	jQuery('#undergraduate_direct_assesment<?php echo $academic_year;?>').html('<option>-- Select --</option>'); 
...
<div class="multiselect">
	...
	<div class="selectBox" onclick="undergraduate_showCheckboxes<?php echo $academic_year;?>()">

		<select class="form-control required" id="undergraduate_direct_assesment<?php echo $academic_year;?>" name="undergraduate_direct_assesment">
	...
	<div id="undergraduate_checkboxes<?php echo $academic_year;?>">
...
#undergraduate_checkboxes_indam<?php echo $academic_year;?> {
...
#undergraduate_checkboxes_indam<?php echo $academic_year;?> label {

  display: inline-block;padding: 3px 15px;width: 100%;color: #fff;font-size: 17px; text-align:left;

  }

#undergraduate_checkboxes_indam<?php echo $academic_year;?> label:hover {
...
function undergraduate_showCheckboxes_indam<?php echo $academic_year;?>() {

  var checkboxes = document.getElementById("undergraduate_checkboxes_indam<?php echo $academic_year;?>");

  if (!expanded) {

  	jQuery('#undergraduate_indirect_assesment<?php echo $academic_year;?>').html('<option>Click Here to Hide Options</option>'); 
    ...
    expanded = true;
  	...
  	jQuery('#undergraduate_indirect_assesment<?php echo $academic_year;?>').html('<option>-- Select --</option>'); 
...
<div class="multiselect">
	...
	<div class="selectBox" onclick="undergraduate_showCheckboxes_indam<?php echo $academic_year;?>()">

		<select class="form-control required" id="undergraduate_indirect_assesment<?php echo $academic_year;?>" name="undergraduate_indirect_assesment">
	...
	<div id="undergraduate_checkboxes_indam<?php echo $academic_year;?>">
		...
		<?php if(isset($checklist_detail->undergraduate_INDAM) && $checklist_detail->undergraduate_INDAM!=''){
			...
			<label for="lab_undergraduate_indam_<?php echo $direct_inassessment_details->name;?><?php echo $academic_year;?>">

			<input type="checkbox" name="undergraduate_indam<?php echo $academic_year;?>[]" id="lab_undergraduate_indam_<?php echo $direct_inassessment_details->name;?><?php echo $academic_year;?>"  <?php if(in_array($direct_inassessment_details->id,$selected_indam_arr)){?> checked="checked" <?php } ?> value="<?php echo $direct_inassessment_details->id;?>" /> &nbsp;&nbsp;<?php echo $direct_inassessment_details->name;?></label>
...
<div style="margin:10px 0; font-weight:600;"><?php echo implode(', ',$indam_name_arr);?></div>
	...
	<textarea class="form-control" name="undergraduate_criteria_<?php echo $academic_year;?>" rows="3" style="resize:none;"  id="undergraduate_criteria_<?php echo $academic_year;?>"><?php if(isset($benchmark_tabuler_details->criteria) && $benchmark_tabuler_details->criteria!=''){ echo $benchmark_tabuler_details->criteria;}?></textarea>
