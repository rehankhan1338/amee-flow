	...
	<tbody>
		...
		?>
			<tr>
				...
				<td>
				<?php
				$plsos_details_data = get_plsos_details_from_year_id_h($dept_detail->id,$ass_status_value,$academic_year,$ass_rotation_plan_status);
				...
				<td>
				<?php
					$courses_details_data = get_courses_details_from_year_id_h($dept_detail->id,$ass_status_value,$academic_year,$ass_rotation_plan_status);
