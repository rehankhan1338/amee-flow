...
<div id="page_dept_checklist">
	...
	<div style="text-align: center;">
	  ...
	  <h3 style=" margin:10px 0;color:#485b79; font-style:italic;"><b><?php echo $this->config->item('project_name_page_first');?></b></h3>
    ...
    <div style="margin:10px 0;">	
	    <h3 style="color: #485b79; font-weight:600;">Introduction</h3>
	...
	<div style="margin:10px 0;">	
	    <h3 style="color: #485b79; font-weight:600;">Co-ordinate Review</h3>
	...
	<div style="margin:10px 0;">	
	    <h3 style="color: #485b79; font-weight:600;">Design Review</h3>
 		<div style="font-size: 16px;color:#333;line-height: 22px;">
	...
	<div style="margin:10px 0;">	
	    <h3 style="color: #485b79; font-weight:600;">Reflect Review</h3>
 		<div style="font-size: 16px;color:#333;line-height: 22px;">
