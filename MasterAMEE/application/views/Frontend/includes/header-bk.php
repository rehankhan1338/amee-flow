...
<?php if(isset($active_class) && $active_class=='tickets_menu'){?>
...
/*jQuery(document).ready(function(){      	
	myAjaxCall('<?php echo $_SESSION['session_start_date_time'];?>','<?php echo base_url();?>','<?php if(isset($activity_name) && $activity_name!=''){echo $activity_name;}?>');   		
});
function myAjaxCall(session_start_date_time,base_url,activity_name){
	 $.ajax({
		url: base_url+'reports/save_time_tracker_ajax?ses_tym='+session_start_date_time+'&activity_name='+activity_name,
		type: 'GET',		
		success: function (result) {
			window.setInterval(function(){
				myAjaxCall(session_start_date_time,base_url,activity_name);
			}, 300000);// 5-minit=300000-milliseconds			        
		}
	});
}*/
</script>
...
<div class="bodywrapper">
    <div class="topheader">
        ...
        <div class="right">
        	<div class="notiBell">
                <a data-toggle="tooltip" title="View All Notifications" class="cnt" href="<?php echo base_url().'notifications';?>"><span><i class="fa fa-bell-o"></i></span></a>
        	</div>
            <div class="userinfo">
