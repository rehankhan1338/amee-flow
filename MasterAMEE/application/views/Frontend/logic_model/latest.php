...
.situ_prio{display:flex;width:100%;justify-content:flex-start;align-items:stretch;max-height:630px;height:100%}
...
.sub_col_title{margin-top:10px;display:flex;justify-content:space-around;font-weight:700; min-height:42px;}
