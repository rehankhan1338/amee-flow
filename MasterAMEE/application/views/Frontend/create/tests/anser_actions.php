...
<script type="text/javascript">
		...
		if(status=='plus'){			 
			jQuery("#choice_count").html(cnt);	
				var html = '<div class="col-md-12" id="div_choice_'+cnt+'"><div class="col-md-8"><div class="form-group answer_fields"><input type="text" name="choice_'+cnt+'" id="choice_'+cnt+'" value="" class="form-control required" placeholder="Insert text to write Choice '+cnt+'"  /></div></div>';
				var html = html+'<div class="col-md-4"><div class="form-group" style="padding-left:60px;"><input type="radio" name="answer_radio" id="answer_radio" value="'+cnt+'" style="margin: 15px -3px 0;" /></div></div></div>';
...
<div class="form-group" style="display:none;" id="validation_error_message_div">
	<div class="col-md-12 ">
		<div class="col-md-12 ">
			<label>Error Message: Add a message to relay the question is required.</label>
		</div>
