...
<div class="survey_heading">
	<h3><?php echo ucwords($test_details->test_title);?> : : Question : : Add</h3>
</div>
<div class="clearfix"></div>
...
<form data-toggle="validator" class="form-horizontal" action="<?php echo base_url();?>tests/question_save" id="frm" method="post" enctype="multipart/form-data">
	...
	function manage_questions(question_type_id){
		...
		jQuery("#hidden_question_type").val(question_type_id);
		 ...
		 if(question_type_id!=''){
			...
			jQuery.ajax({
				url: '<?php echo base_url(); ?>tests/get_default_question_choice?question_type='+question_type_id,
				type: 'GET',
				beforeSend: function () {
				...
				success: function (result) {  //alert(result);
					...
					//if(question_type_id==1 || question_type_id==2 || question_type_id==3){
						jQuery.ajax({
							url: '<?php echo base_url(); ?>tests/get_action_html_of_answer?question_type='+question_type_id,
							type: 'GET',
							beforeSend: function () {
