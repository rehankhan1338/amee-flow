...
<table class="matrix table " >
		<thead>
			<tr class="append_matric_column " style="text-align:center;">
				<td colspan="2" style="text-align:center; vertical-align:middle; font-weight:600;"></td>
		...
		<tbody>
			<?php $k=1; foreach($get_rows as $rows){?>
				...
				<tr class="matrix_rownnn old_div_statement_<?php echo $k;?>" style="border-top:1px solid #dedede;">
					<td style="vertical-align:middle;" width="3%"><a onclick="return confirm('Are you sure want to delete it?');" style="color:#FF0000; font-size:18px; display:inline-block;" href="<?php echo base_url().'survey/delete_question_opt?rowId='.$rows->row_id.'&quesId'.$edit_question_fulldetails->question_id;?>"> <i class="fa fa-trash-o"></i></a></td>
					<td>
