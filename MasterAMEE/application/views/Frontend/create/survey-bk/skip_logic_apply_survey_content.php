...
<div class="modal-content">
	...
	<div class="modal-body">
			...
			<div class="col-md-12">
				<?php if(isset($survey_question_details->question_type) && $survey_question_details->question_type==1){?>
	...
	<?php if(isset($survey_details->question_per_page) && $survey_details->question_per_page==1 && isset($survey_question_details->question_type) && ($survey_question_details->question_type==1 || $survey_question_details->question_type==2)){?>
	<div class="modal-footer">
		...
		<button type="button" class="btn btn-primary" style="padding:3px 7px; font-size:15px;" onclick="return add_skip_logic('<?php echo $survey_id;?>','<?php echo $survey_question_details->question_id;?>','<?php echo $survey_question_details->question_type;?>','<?php echo $survey_question_details->priority;?>');"><i class="fa fa-plus-circle" aria-hidden="true"></i> Add New Skip Logic...</button>
