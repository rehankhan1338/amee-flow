...
<form data-toggle="validator" class="" id="frm" method="post" action="" enctype="multipart/form-data">
	<div class="col-md-12 instructions"><b>Note:</b> Only change the mail title.  Changing other fields will dismantle use of the AMEE solution.</div>
	<div class="row">
	...
	<!-- left column -->
		...
		<div class="col-md-4">          
			<div class="box">          
				<div class="box-header with-border">
					<h3 class="box-title">Academic year for Rotational Plan</h3>
				</div>

				<div class="box-body">
					<div class="col-md-12">						 
						<div class="form-group">
							<label  for="inputEmail3">Academic year for Rotational Plan*</label>
							<input type="text" class="form-control required" id="academic_year" name="academic_year" placeholder="Academic year" value="<?php if(isset($configuration_details->academic_year) && $configuration_details->academic_year!=''){ echo $configuration_details->academic_year;}?>" />
						</div>
					</div>
				</div> 
			</div>
