...
<form data-toggle="validator" class="form-horizontal" action="<?php echo base_url();?>admin/survey_template/question_save" id="frm" method="post" enctype="multipart/form-data">
	...
	<div class="col-md-12 survey_inner_question_title">
		...
		<div class="col-md-12 form-group">
			<input type="text" class="form-control required" id="survey_question_title" style="height:40px; width:70%;display: contents;" name="survey_question_title"   placeholder="Question Title" value="" />
		</div>
	</div>
